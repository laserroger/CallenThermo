...
“{\it 几乎}”%
\mpar{原文为 essentially}%
这个词是一个重要限定条件，实际上我们可观测的宏观过程是几乎完全，但也不确切的，不依赖于时间的。稍微努力一点的话，人类可以观测时间尺度在=\SI{e-7}{\second}或更短一点的过程%
\mpar{借助近年来迅速发展的飞秒光学和阿秒光学的手段，人们已经可以测量到数十阿秒(\SI{1}{\atto\second}=\SI{e-18}{\second})时间上发生的过程了。}%
...
\mpar{通过扫描电子显微镜(SEM)、扫描隧道显微镜(STM)、原子力显微镜(AFM)等手段，人们已经可以分辨亚原子尺度的结构。而 SEM 利用的就是短波长的高能电子。}%
...
\mpar{尽管如此，至今依旧有人在讨论构建完全排除负温度的统计物理体系的可能性，例如 Dunkel, J. \& Hilbert, S. Consistent thermostatistics forbids negative absolute temperatures. Nature Physics 10, 67–72 (2013).}
