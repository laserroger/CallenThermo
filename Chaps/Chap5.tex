...
{\it 亥姆霍兹（Helmholtz）势}或者{\it 亥姆霍兹（Helmholtz）自由能}，是$U$用温度代替熵成为独立变量的勒让德（Legendre）变换。
...
第三个常用的能量的勒让德（Legendre）变换是{\it 吉布斯（Gibbs）势}或者叫{\it 吉布斯（Gibbs）自由能}。
